...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-[rgb(30,58,138)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pl-10 mt-10 lg:mt-0">
            <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
              <Terminal className="text-primary-300" />
              Pasión por el código
            </h3>

            <p className="text-white leading-relaxed mb-6 text-lg">
              Apasionado de la programación desde niño, comencé mi viaje tecnológico programando en un <span className="font-semibold text-white">Atari ST</span> con tan solo 13 años. Lo que empezó como curiosidad se convirtió en mi profesión y vocación.
            </p>
